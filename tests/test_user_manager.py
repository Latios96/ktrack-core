...
def test_create_user():
    with patch.object(__builtin__, 'raw_input') as mock_raw_input:
        ...
        with patch("ktrack_api.get_ktrack") as mock_kt:
            ...
            kt.create.assert_called_with("user", {'name': "sSonny", 'first_name': "sonny", 'second_name': "sonny"})
...
def test_save_user_information(tmpdir):
    ...
    # mock test dir
    with patch("kttk.user_manager.get_user_information_path") as mock_user_information_path:
