...
class TestTemplateMatcher(object):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (ASSET_TYPE_FOLDER, "M:/Projekte/2018/test/Asets/Prop"),
            (ASSET_TYPE_FOLDER, "M:/Projekte/2018/test/Assetss/Prop"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                PROJECT_NAME_WITH_UNDERSCORE,
                "test_ing/test_ing_Prop_v001.mb",
                {
                    "project_name": "test_ing",
                    "folder_seperator": "/",
                    "asset_type": "Prop",
                    "underscore": "_",
                    "version_number": "v001",
    ...
    def _test_should_match_template_debug(self):
        matcher = PathTokenSequenceMatcher(
            self.PROJECT_NAME_WITH_UNDERSCORE, "test_ing/test_ing_Prop_v001.mb"
        )
